    ...
    <main className="bg-white">
      ...
      <div className="bg-[#0F172A] py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mt-2 font-['Chivo'] animate-fade-up">Careers at DFAB</h1>
      ...
      <section className="py-16 md:py-24 bg-slate-50" ref={whyRef}>
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-12 reveal">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mt-2 font-['Chivo']">Why Work With Us</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 stagger-children">
            {WHY_DFAB.map((item) => (
              <div key={item.title} className="reveal bg-white border border-slate-200 rounded-md p-6 text-center hover:border-[#0A66C2] hover:shadow-sm transition-all duration-300">
      ...
      <section className="py-16 md:py-24" ref={openingsRef}>
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-12 reveal">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mt-2 font-['Chivo']">Current Openings</h2>
            <p className="text-slate-600 mt-3 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 stagger-children">
            {OPENINGS.map((job) => (
              ...
              >
                <div className="flex items-start justify-between gap-4 mb-4">
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-2">
                      ...
                      <span className="text-xs bg-blue-50 text-[#0A66C2] font-semibold px-2.5 py-1 rounded-full">{job.type}</span>
                      <span className="text-xs bg-slate-100 text-slate-600 px-2.5 py-1 rounded-full">{job.experience}</span>
                    </div>
                  </div>
                </div>
                ...
                <a
                  href="mailto:info@dfab.in?subject=Job Application"
      ...
      <div className="bg-[#0A66C2] py-10">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="mailto:info@dfab.in" className="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-5 py-2.5 rounded-sm text-sm font-medium transition-colors">
              <Mail size={15} /> info@dfab.in
            </a>
            <a href="tel:+918043748186" className="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-5 py-2.5 rounded-sm text-sm font-medium transition-colors">
