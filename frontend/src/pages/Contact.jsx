...
export default function Contact() {
  ...
  return (
    <main className="bg-white">
      ...
      {/* ✅ HEADER SECTION - STATIC (Animations Removed) */}
      <div className="bg-[#0F172A] h-[260px] flex items-center px-4">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <p className="text-slate-400 mt-3 max-w-2xl leading-relaxed">
            Reach out to our team today. We are ready to help you engineer high-precision 
            solutions tailored to your specific industrial needs.
          </p>
