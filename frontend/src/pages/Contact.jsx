    ...
    <main className="bg-white">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="lg:col-span-3 border border-slate-200 p-8 rounded-md shadow-sm bg-white h-full flex flex-col">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 flex-grow flex flex-col justify-between">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 bg-[#0A66C2] hover:bg-[#084e96] text-white py-3 rounded-md font-semibold transition-colors disabled:opacity-60 mt-4"
                >
                  <Send size={16} />
          ...
          <div className="mt-16">
            <h3 className="text-2xl font-bold mb-6 text-slate-900 font-['Chivo']">
              Our Location
            </h3>
