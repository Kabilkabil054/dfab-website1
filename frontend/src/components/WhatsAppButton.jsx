...
export default function WhatsAppButton() {
  ...
  return (
    <a
      href="https://wa.me/918072394136"
      target="_blank"
      rel="noreferrer"
      data-testid="whatsapp-float-btn"
      className="fixed bottom-6 left-6 z-50 flex items-center gap-2 bg-[#25D366] text-white px-4 py-3 rounded-full shadow-lg hover:bg-[#1ebe5d] transition-colors text-sm font-medium"
